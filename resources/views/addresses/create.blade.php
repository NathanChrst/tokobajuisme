<x-app-layout>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="mb-8 flex items-center">
            ...
            <h1 class="font-serif text-3xl text-[#3D405B] font-bold">Tambah Alamat Baru</h1>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl border border-gray-200/60 shadow-sm">
            <form action="{{ route('addresses.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="label" value="{{ old('label') }}" placeholder="Contoh: Rumah, Kantor, Kosan" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-[#E07A5F] focus:ring-[#E07A5F]" required>
                ...
                <div>
                    ...
                    <textarea name="street" rows="3" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-[#E07A5F] focus:ring-[#E07A5F]" required>{{ old('street') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="city" value="{{ old('city') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-[#E07A5F] focus:ring-[#E07A5F]" required>
                        @error('city')<span class="text-sm text-red-500 mt-1">{{ $message }}</span>@enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Provinsi</label>
                        <input type="text" name="province" value="{{ old('province') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-[#E07A5F] focus:ring-[#E07A5F]" required>
                ...
                <div>
                    ...
                    <input type="text" name="postal_code" value="{{ old('postal_code') }}" class="w-full md:w-1/2 rounded-xl border-gray-300 shadow-sm focus:border-[#E07A5F] focus:ring-[#E07A5F]" required>
                    @error('postal_code')<span class="text-sm text-red-500 mt-1">{{ $message }}</span>@enderror
                </div>

                <div class="flex items-center">
                    <input type="checkbox" name="is_default" id="is_default" value="1" class="rounded text-[#E07A5F] focus:ring-[#E07A5F] border-gray-300">
