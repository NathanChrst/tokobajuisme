<x-admin-layout>
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-4 border-b border-[#232336] max-w-2xl mx-auto">
        <div>
            <h1 class="font-serif font-bold text-2xl sm:text-3xl text-white tracking-tight">Tambah Kategori Baru</h1>
            <p class="text-xs sm:text-sm text-slate-400 mt-1">Tambahkan kategori busana baru</p>
        </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-xl bg-[#161622] border border-[#232336] text-white placeholder-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/25 shadow-sm text-sm" placeholder="Contoh: Kemeja Formal">
